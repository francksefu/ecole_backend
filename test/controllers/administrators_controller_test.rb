...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { date_of_birth: @administrator.date_of_birth, first_name: @administrator.first_name, last_name: @administrator.last_name, name: @administrator.name, phone: @administrator.phone } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { date_of_birth: @administrator.date_of_birth, first_name: @administrator.first_name, last_name: @administrator.last_name, name: @administrator.name, phone: @administrator.phone } }
