...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference("Parent.count") do
      post parents_url, params: { parent: { date_of_birth: @parent.date_of_birth, first_name: @parent.first_name, last_name: @parent.last_name, name: @parent.name, phone: @parent.phone } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { date_of_birth: @parent.date_of_birth, first_name: @parent.first_name, last_name: @parent.last_name, name: @parent.name, phone: @parent.phone } }
