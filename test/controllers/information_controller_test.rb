...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { content: @information.content, date: @information.date, distination: @information.distination, source: @information.source } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { content: @information.content, date: @information.date, distination: @information.distination, source: @information.source } }
