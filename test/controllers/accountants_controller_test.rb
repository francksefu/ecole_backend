...
class AccountantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accountant" do
    assert_difference("Accountant.count") do
      post accountants_url, params: { accountant: { date_of_birth: @accountant.date_of_birth, first_name: @accountant.first_name, last_name: @accountant.last_name, name: @accountant.name, phone: @accountant.phone } }
    end
  ...
  test "should update accountant" do
    patch accountant_url(@accountant), params: { accountant: { date_of_birth: @accountant.date_of_birth, first_name: @accountant.first_name, last_name: @accountant.last_name, name: @accountant.name, phone: @accountant.phone } }
